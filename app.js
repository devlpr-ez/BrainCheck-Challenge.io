// app.js (ES Module)
const DB_NAME = 'teacherapp_web';
const DB_VERSION = 1;
let db;

const sampleActivities = [
  { id:'mc1', type:'mcq', title:'Largest planet', question:'What is the largest planet in our solar system?', choices:['Earth','Jupiter','Mars','Saturn'], answer:'Jupiter', points:10 },
  { id:'mc2', type:'mcq', title:'Capital of France', question:'What is the capital of France?', choices:['London','Berlin','Paris','Madrid'], answer:'Paris', points:10 },
  { id:'dd1', type:'drag', title:'Classify animals', question:'Drag animals to categories', pairs:{Dog:'Mammals',Eagle:'Birds',Shark:'Fish',Cat:'Mammals'}, categories:['Mammals','Birds','Fish'], points:20 },
